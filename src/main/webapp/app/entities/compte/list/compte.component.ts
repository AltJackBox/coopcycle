...
export class CompteComponent implements OnInit {
  ...
  constructor(protected compteService: CompteService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.comptes = [];
    ...
    this.compteService
      ...
      .subscribe(
        (res: HttpResponse<ICompte[]>) => {
          ...
          this.paginateComptes(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
