...
class ProduitResourceIT {
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit().name(DEFAULT_NAME).price(DEFAULT_PRICE).isAvailable(DEFAULT_IS_AVAILABLE);
        return produit;
    }
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit().name(UPDATED_NAME).price(UPDATED_PRICE).isAvailable(UPDATED_IS_AVAILABLE);
        return produit;
    }
    ...
    void createProduit() throws Exception {
        ...
        assertThat(testProduit.getIsAvailable()).isEqualTo(DEFAULT_IS_AVAILABLE);
    }
    ...
    void putNewProduit() throws Exception {
        ...
        updatedProduit.name(UPDATED_NAME).price(UPDATED_PRICE).isAvailable(UPDATED_IS_AVAILABLE);
        ...
        assertThat(testProduit.getIsAvailable()).isEqualTo(UPDATED_IS_AVAILABLE);
    }
    ...
    void fullUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.name(UPDATED_NAME).price(UPDATED_PRICE).isAvailable(UPDATED_IS_AVAILABLE);
