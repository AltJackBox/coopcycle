...
class CooperativeResourceIT {
    ...
    private static final String DEFAULT_GEOGRAPHICAL_AREA = "AAAAAAAAAA";
    private static final String UPDATED_GEOGRAPHICAL_AREA = "BBBBBBBBBB";
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(DEFAULT_NAME).geographicalArea(DEFAULT_GEOGRAPHICAL_AREA);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(UPDATED_NAME).geographicalArea(UPDATED_GEOGRAPHICAL_AREA);
        return cooperative;
    }
    ...
    void createCooperative() throws Exception {
        ...
        assertThat(testCooperative.getGeographicalArea()).isEqualTo(DEFAULT_GEOGRAPHICAL_AREA);
    }
    ...
    void getAllCooperatives() throws Exception {
        ...
        restCooperativeMockMvc
            ...
            .andExpect(jsonPath("$.[*].geographicalArea").value(hasItem(DEFAULT_GEOGRAPHICAL_AREA)));
    }
    ...
    void getCooperative() throws Exception {
        ...
        restCooperativeMockMvc
            ...
            .andExpect(jsonPath("$.geographicalArea").value(DEFAULT_GEOGRAPHICAL_AREA));
    }
    ...
    void putNewCooperative() throws Exception {
        ...
        updatedCooperative.name(UPDATED_NAME).geographicalArea(UPDATED_GEOGRAPHICAL_AREA);
        ...
        assertThat(testCooperative.getGeographicalArea()).isEqualTo(UPDATED_GEOGRAPHICAL_AREA);
    }
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.name(UPDATED_NAME).geographicalArea(UPDATED_GEOGRAPHICAL_AREA);
