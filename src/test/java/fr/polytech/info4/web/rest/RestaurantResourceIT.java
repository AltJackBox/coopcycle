...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).openTime(DEFAULT_OPEN_TIME).closeTime(DEFAULT_CLOSE_TIME);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).openTime(UPDATED_OPEN_TIME).closeTime(UPDATED_CLOSE_TIME);
        return restaurant;
    }
    ...
    void putNewRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).openTime(UPDATED_OPEN_TIME).closeTime(UPDATED_CLOSE_TIME);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).openTime(UPDATED_OPEN_TIME).closeTime(UPDATED_CLOSE_TIME);
